...
public class Swagger2Configuration {
	...
	public Docket accessToken() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("api")// 定义组
				...
				.apis(RequestHandlerSelectors.basePackage("com.yangjun.controller")) // 拦截的包路径
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()//
				.title("SpringBoot测试")// 标题
				.description("SpringBoot测试项目")// 描述
				.termsOfServiceUrl("http://www.roncoo.com")//
				.contact(new Contact("杨俊", "http://www.baidu.com", "125960563@qq.com"))// 联系
