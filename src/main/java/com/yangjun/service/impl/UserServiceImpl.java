...
import com.yangjun.common.TokenCache;
import com.yangjun.dao.UserMapper;
import com.yangjun.pojo.User;
import com.yangjun.service.IUserService;
import com.yangjun.util.MD5Util;
...
public class UserServiceImpl implements IUserService{
    ...
    public  ServerResponse<String> register(User user){
        ...
        int resutltCount = userMapper.insert(user);
        if(resutltCount==0){
    ...
    public ServerResponse<String> checkValid(String str,String type){
        if(StringUtils.isNoneBlank(type)){
            ...
            if(Const.USERNAME.equals(type)){
                int resutltCount = userMapper.checkUsername(str);
                if(resutltCount>0){
            ...
            if(Const.EMAIL.equals(type)){
                int resutltCount = userMapper.checkEmail(str);
                if(resutltCount>0){
